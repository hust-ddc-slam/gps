...
%% file path
% test1
data_folder = "E:\SLAM\2024.8.23-datas";
data_name = "606.2264";
...
slam_trajectory_raw_filename = "E:\SLAM\2024.8.23-datas\fastlio.txt";
gps_cleaned_filename = "E:\SLAM\2024.8.23-datas\data_clean\gps1.txt";
bag_name = "E:\SLAM\2024.8.23-datas\1970-01-01-08-10-22.bag";
trajectoryfilename = "E:\SLAM\2024.8.23-datas\data_clean\gps1_trac.txt";
...
[gps_ts, gps_raw, gps_heading] = loadGpsData(gps_cleaned_filename,trajectoryfilename);
skip_num = 10;
...
theta = deg2rad(6);%(gps_init_heading);			% 夹角加上90°，从北->GPS的x
